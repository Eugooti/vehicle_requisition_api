...
const readAllocationRequests = async (req,res) => {
  try {
...
const readApprovalRequests = async (req,res) => {
  try {
      const today = new Date().toISOString().split('T')[0]; // Format: 'YYYY-MM-DD'
...
module.exports = {readRequisitionsByDepartment,readAllRequisition,readTripsByUser,readAllocationRequests,readApprovalRequests};